...
$page_title = 'S.E.T. OBmembers Page';

// Specify PukiWiki URL (default: auto)
$script = 'http://aitech.ac.jp/set1/wiki/';

// Shorten $script: Cut its file name (default: not cut)
//$script_directory_index = 'index.php';

// Site admin's name (CHANGE THIS)
$modifier = 'Yokoyama@SETserverAdmin';

// Site admin's Web page (CHANGE THIS)
$modifierlink = 'http://www.sysken.net/';

// Default page name
$defaultpage  = 'S.E.T. OB/OG TopPage';     // Top / Default page
$whatsnew     = 'RecentChanges'; // Modified page list
$whatsdeleted = 'RecentDeleted'; // Removeed page list
$interwiki    = 'InterWikiName'; // Set InterWiki definition here
$menubar      = 'SiteMenu';       // Menu
