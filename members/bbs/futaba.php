...
define("TITLE", 'シス研画像掲示板');		//タイトル（<title>とTOP）
define("HOME",  '../index.html');	//「ホーム」へのリンク
define("MAX_KB", '8192');		//投稿容量制限 KB（phpの設定により2Mまで
define("MAX_W",  '300');		//投稿サイズ幅（これ以上はwidthを縮小
define("MAX_H",  '300');		//投稿サイズ高さ
define("PAGE_DEF", '20');		//一ページに表示する記事
define("LOG_MAX",  '10000');		//ログ最大行数
define("ADMIN_PASS", '[set:su]');	//管理者パス
...
define("BR_CHECK", 30);		//改行を抑制する行数 しない:0
...
<LI>'.MAX_RES.'レスつくと自動的にsageになります。
<LI>グロは厳禁。過度なわいせつ画像は管理人が逮捕されるので
<font size="4" color="#ff0000"><B>お願いですからやめてください。</B></f>
