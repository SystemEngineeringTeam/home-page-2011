...
define('DATA_DIR',      DATA_HOME . 'text/'     ); // Latest wiki texts
...
$modifier = 'System Engineering Team - Server Administrators';

// Site admin's Web page (CHANGE THIS)
$modifierlink = 'http://set1.ie.aitech.ac.jp/';
